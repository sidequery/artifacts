# Local workspace and MCP reference

This guide covers the file-based Bun CLI, stdio MCP server, gallery, and
...
The file-based workspace runtime has no multi-user authentication. Keep the web
