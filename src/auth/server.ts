...
export function authPageHtml(): string {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Canvas authentication</title><style>html,body{margin:0;background:#141414;color:#e5e5e5;font-family:system-ui,sans-serif}*{box-sizing:border-box}</style></head><body><div id="root"></div><script type="module" src="/auth.js"></script></body></html>`;
}
